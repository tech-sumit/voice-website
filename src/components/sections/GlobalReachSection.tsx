            ...
            >
              {sortedLanguages.map((lang) => (
                <motion.div
                  key={lang}
                  variants={item}
                  className="group relative flex items-center gap-3 p-3 bg-[var(--hw-chassis)] border border-[var(--hw-border)] rounded hover:bg-white dark:hover:bg-neutral-800 hover:border-[#FF5722] hover:shadow-md transition-all duration-200 cursor-default select-none"
                >
