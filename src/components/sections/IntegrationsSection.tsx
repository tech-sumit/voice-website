                ...
                >
                  {tools.map((tool) => (
                    <motion.div
                      key={tool.name}
                      variants={item}
                      className="group relative flex flex-col items-center justify-center gap-2 p-4 bg-[var(--hw-chassis)] border border-[var(--hw-border)] rounded hover:bg-white dark:hover:bg-neutral-800 hover:border-[#FF5722] hover:shadow-md transition-all duration-200 cursor-default select-none h-28"
                    >
