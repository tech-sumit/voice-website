...
export default function IntegrationsSection() {
  ...
  return (
    <section 
      ...
      className="py-20 bg-surface-50 dark:bg-surface-900 overflow-hidden relative"
    >
      {/* Background decoration */}
      <div className="absolute top-1/3 right-0 w-64 h-64 bg-primary-50/50 dark:bg-primary-900/20 rounded-full blur-3xl opacity-50 -z-10"></div>
      <div className="absolute bottom-1/3 left-0 w-64 h-64 bg-accent-50/50 dark:bg-accent-900/20 rounded-full blur-3xl opacity-50 -z-10"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <motion.div
            className="inline-flex items-center px-3 py-1 rounded-full bg-primary-100 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 text-primary-800 dark:text-primary-300 text-sm font-medium mb-4"
          >
            <motion.span 
          ...
          <motion.h2 
            ...
            className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-accent-500"
          >
          ...
          <motion.p
            ...
            className="mt-4 text-xl text-neutral-700 dark:text-neutral-300 max-w-2xl mx-auto"
          >
