...
export default function UseCaseSection() {
  ...
  return (
    <section ref={ref} id="use-cases" className="py-16 bg-surface-50 dark:bg-surface-900 relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute inset-0 bg-grid-pattern opacity-[0.03] dark:opacity-[0.05]"></div>
      <div className="absolute top-0 left-0 w-[30rem] h-[30rem] bg-primary-400/20 dark:bg-primary-500/10 rounded-full blur-[100px] -translate-y-1/2 -translate-x-1/3"></div>
      <div className="absolute bottom-0 right-0 w-[35rem] h-[35rem] bg-accent-400/15 dark:bg-accent-500/10 rounded-full blur-[100px] translate-y-1/3 translate-x-1/4"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Perfect for <span className="text-gradient-primary">All Industries</span>
          </motion.h2>
